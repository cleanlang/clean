...
const { languageConstructs, reservedFnCalls } = require('./languageConstructs')
const opSpec = require('./operatorPrecedence')
/*  Utility functions  */
const maybe = (value, func) => (value === null ? null : func(...value))
const isLanguageConstruct = (id) => languageConstructs[id]
const isReservedFnCall = (id) => reservedFnCalls[id]
