...
const inbuiltProps = {
  ...
  needsInference: {
    length: {
      spec: setValues(false, true, false, null, 'number'),
      parentType: 'needsInference',
    },
    push: {
      spec: setValues(true, false, true, null, null),
    ...
    map: {
      spec: setValues(true, false, false, ['needsInference'], arrayType),
      parentType: arrayType,
    },
    filter: {
      spec: setValues(true, false, false, ['needsInference'], arrayType),
    ...
    reduce: {
      spec: setValues(true, false, false, ['needsInference'], 'needsInference'),
      parentType: arrayType,
    },
    includes: {
      spec: setValues(true, false, false, ['needsInference'], 'bool'),
      parentType: 'needsInference',
    },
    join: {
      spec: setValues(true, false, false, ['string'], 'string'),
      parentType: arrayType,
    },
    toString: {
      spec: setValues(true, false, false, null, 'string'),
      parentType: 'needsInference',
    },
    concat: {
      spec: setValues(true, false, false, ['array'], arrayType),
      parentType: arrayType,
    },
    charAt: {
      spec: setValues(true, false, false, ['number'], 'string'),
      parentType: 'string',
    },
    charCodeAt: {
      spec: setValues(true, false, false, ['number'], 'number'),
      parentType: 'string',
    },
    substring: {
      spec: setValues(true, false, false, ['number', 'number'], 'string'),
      parentType: 'string',
    },
    substr: {
      spec: setValues(true, false, false, ['number', 'number'], 'string'),
    ...
    startsWith: {
      spec: setValues(true, false, false, ['string'], 'bool'),
      parentType: 'string',
    },
    split: {
      spec: setValues(true, false, false, ['string'], arrayType),
      parentType: 'string',
    },
    replace: {
      spec: setValues(true, false, false, ['string', 'string'], 'string'),
      parentType: 'string',
    },
    match: {
      spec: setValues(true, false, false, ['string'], 'number'),
      parentType: 'string',
    },
    search: {
      spec: setValues(true, false, false, ['string', 'string'], 'string'),
    ...
    hasOwnProperty: {
      spec: setValues(true, false, false, ['string'], 'bool'),
      parentType: { type: 'object', propTypes: {} },
    },
  },
}
