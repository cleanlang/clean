...
const declValueParser = input => parser.any(unaryExprParser, letExpressionParser, ifExprParser,
  ...
  arrayParser, objectParser, lambdaParser, lambdaCallParser, expressionParser)(input)
...
const lambdaArgParser = input => parser.all(spaceParser, parser.any(numberParser, stringParser))(input)
