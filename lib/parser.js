...
const possiblyBinary = parser.all(
                        expressionParser,
                        spaceParser,
...
const statementParser = parser.any(letExpressionParser, declParser, fnDeclParser, fnCallParser, lambdaParser)
