...
const binaryExprParser = src => {
  ...
  if (precedence(nextOperator) > precedence(firstOperator)) {
    ...
    return (nextExpr.type === 'BinaryExpression') && (precedence(nextExpr.operator) < precedence(nextOperator))
