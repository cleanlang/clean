...
var multiLineParser = (src, body = []) => {
  ...
  if (indent < nextIndent && indent !== 0) return blockStmt(body)
  if (nextIndent > indent) {
    console.log(nextLine)
    return multiLineParser(nextLine, body.push(stmt))
  }
  return stmt
}

console.log(JSON.stringify(multiLineParser({str: 'print a\n   print b\n   print c\n print d', indent: 0, column: 0, line: 1}), null, 4))
