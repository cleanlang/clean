...
var binaryExprParser = src => {
  ...
  let result = parser.all(
                          parser.any(unaryExprParser, fnCallParser, expressionParser),
                          spaceParser,
                          binaryOperatorParser,
                          spaceParser,
                          parser.any(unaryExprParser, fnCallParser, expressionParser))(src)
  if (result === null) return null
  ...
  let p = parser.any(binaryExprParser, unaryExprParser, expressionParser)(possibleExpr)
