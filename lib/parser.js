...
const {
  ...
  reverseBindParser, doParser, ioFuncNameParser, //, assignmentOperatorParser
  returnKeywordParser
} = base
...
const ioParser = input => {
  let initIO = parser.all(identifierParser, equalSignParser, parser.any(doParser, ioStmtParser, identifierParser))(input)
