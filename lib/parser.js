...
const declParser = parser.bind(
  ...
  val => input => mayBe(
    parser.any(objectParser, unaryExprParser, letExpressionParser, ifExprParser, binaryExprParser, fnCallParser, expressionParser)(input),
        (v, rest) => {
...
const memberPropsParser = (str, memberArray = []) => {
...
const memberExprParser = (str, tree = {}) => {
