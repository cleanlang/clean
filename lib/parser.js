...
*/
var biOps = require('./binaryOperators.js')
var estemplate = require('./template')
/*  Utility functions  */
var mayBe = (value, func) => value === null ? null : func(...value)
var precedence = operator => biOps[operator].prec
var associativity = operator => biOps[operator].assoc
var lookAhead = src => {
